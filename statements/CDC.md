...
Both [generative and narrow AI models](https://www.industry.gov.au/publications/guidance-for-ai-adoption/mitigating-risks-and-harms) are used in accordance with the DTA’s [classification systems for AI use](https://www.digital.gov.au/policy/ai/resources/use-classification).
...
### [ AI Accountable Officials ](https://www.cdc.gov.au/contacts/ai-accountable-officials)
...
[AI@cdc.gov.au](mailto:AI@cdc.gov.au)