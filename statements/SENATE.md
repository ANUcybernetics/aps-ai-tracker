...
This Transparency Statement is produced in accordance with the Digital Transformation Agency's _[Policy for responsible use of AI in government](https://architecture.digital.gov.au/responsible-use-of-AI-in-government)_.
...
We use ICT provided by the Department of Parliamentary Services under a memorandum of understanding. DPS is committed to responsible and ethical use of AI technologies, and this Transparency Statement should be read in conjunction with the [DPS AI Transparency Statement](https://www.aph.gov.au/About_Parliament/Parliamentary_departments/Department_of_Parliamentary_Services/Publications/AI_Transparency_Statement) and the broader Commonwealth direction and [Parliament of Australia Digital Strategy 2023-2027](https://www.aph.gov.au/About_Parliament/Parliamentary_departments/Department_of_Parliamentary_Services/Publications/Digital_strategies).

## AI adoption and use

We are committed to continuous learning and adaptation, and to using the best possible tools for our work supporting the Senate. We are conscious of the need for AI strategies to evolve along-side the changing needs of the Senate, technological advancements and legislative or regulatory changes. Many aspects of our work require reliable ICT systems that allow staff to receive, share, analyse, collaborate on, and publish information at scale. The advent of standalone AI products, and the introduction of AI functions into mainstream applications, will no doubt change how we approach some of these tasks. We are also conscious of the risks involved, particularly given the need to ensure the veracity of the material we produce. For these reasons, we will be cautious in our adoption of AI tools and strategies in support of the department's aims.

Like other non-corporate Commonwealth entities, our approach to the use of AI is guided by:

- [Australia's Artificial Intelligence Ethics Principles](https://architecture.digital.gov.au/australias-artificial-intelligence-ethics-principles#:~:text=The%20principles%20at%20a%20glance%20are%3A%20Human%2C%20societal,human%20rights%2C%20diversity%2C%20and%20the%20autonomy%20of%20individuals.#:~:text=The%20principles%20at%20a%20glance%20are%3A%20Human%2C%20societal,human%20rights%2C%20diversity%2C%20and%20the%20autonomy%20of%20individuals.)
- DTA's [Policy for responsible use of AI in government and associated standards](https://architecture.digital.gov.au/responsible-use-of-AI-in-government)
- DTA's Technical standard for government's use of artificial intelligence
- Relevant legislation and regulations

### How we use Al

In line with the Digital Transformation Agency and Australian Government Architecture, and the Department's ICT provider, DPS, we have adopted the [OECD definition](https://architecture.digital.gov.au/ai) of what constitutes artificial intelligence.
...
The table below shows the use, by the Department of the Senate, of AI based on the DTA classification system, available at [digital.gov.au/ai/resources/use-classification](https://www.digital.gov.au/policy/ai/resources/use-classification).
...
The Usher of the Black Rod has been appointed Chief AI Officer.

#### Accountable Official

The Clerk Assistant (Table) has been appointed the Accountable Official.
...
For further information about the use of AI within the Department of the Senate, please contact [spio@aph.gov.au](mailto:spio@aph.gov.au)