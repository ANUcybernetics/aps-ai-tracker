...
fetched_at: '2025-11-11T06:11:16.369459+00:00'
...
We use automation and AI in the following usage patterns and domains, which align to the Digital Transformation Agency’s (DTA) [Classification system for AI use](https://www.digital.gov.au/policy/ai/resources/use-classification).
...
Learn more about [how we use Artificial Intelligence](https://www.servicesaustralia.gov.au/how-we-use-artificial-intelligence?context=22).
...
We’ve appointed the General Manager, Telecommunication Modernisation, Automation and Architecture as our accountable official for AI, in accordance with the DTA’s [Standard for accountable officials](https://architecture.digital.gov.au/standard-accountable-officials). The accountable official oversees high-risk AI use cases and ensures we comply with whole-of-government AI policies and ethical guidelines.
