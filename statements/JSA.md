...
- _AI in Procurement Principle_ in place that help to ensure where third-party providers are using AI as part of delivering services to the department, the risks have been considered, the usage is transparent to, and agreed to by the department, and that AI-aware quality assurance processes are in place.
