...
This AI transparency statement outlines the PBO's approach to AI, aligned with the broader Commonwealth direction and the [Parliament of Australia Digital Strategy 2023-2027](https://www.aph.gov.au/About_Parliament/Parliamentary_departments/Department_of_Parliamentary_Services/Publications/Digital_strategies).
...
The PBO’s Chief Operating Officer (COO) is the PBO’s accountable official, appointed in line with the [DTA standard for accountable officials](https://www.digital.gov.au/policy/ai/accountable-officials).
...
- [Australia’s AI ethics principles](https://architecture.digital.gov.au/australias-artificial-intelligence-ethics-principles)
...
- harness business benefits whilst effectively mitigating and managing risks align with the [Parliament of Australia's Digital Strategy](https://www.aph.gov.au/About_Parliament/Parliamentary_departments/Department_of_Parliamentary_Services/Publications/Digital_strategies)
...
The PBO follow the Organisation for Economic Cooperation and Development’s (OECD) [definition](https://doi.org/10.1787/623da898-en) of what constitutes AI, and considers the risks and benefits of its use against the [DTA classification system for AI](https://www.digital.gov.au/policy/ai/resources/use-classification).
...
For example, the PBO’s Registration App (used to register costing requests from parliamentarians) includes an ’Assisted Registration’ mode to extract information from PDF documents and populate the registration data fields. Staff then review the information to confirm accuracy prior to submitting the request for processing. This streamlines the registration workflow and reduces errors from manual retyping, enhancing productivity.
...
The PBO outsources ICT service provision to DPS. As the ICT service provider to the Parliament, the Parliamentary departments and Parliamentary Workplace Support Service (PWSS), DPS provides the overarching environment and framework for AI. The [DPS AI Transparency statement](https://www.aph.gov.au/About_Parliament/Parliamentary_departments/Department_of_Parliamentary_Services/Publications/AI_Transparency_Statement) includes information on how DPS uses AI to provide ICT services to the PBO.
...
- new AI use cases or requests to use AI are reported to the PBO AI Accountable official (PBO COO)
