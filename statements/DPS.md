...
- compliance with the _DTA policy for the responsible use of AI in Government_
...
- _[Australia’s AI ethics principles](https://architecture.digital.gov.au/strategy/australias-artificial-intelligence-ethics-principles#:~:text=The%20principles%20at%20a%20glance%20are%3A%20Human%2C%20societal,human%20rights%2C%20diversity%2C%20and%20the%20autonomy%20of%20individuals.#:~:text=The%20principles%20at%20a%20glance%20are%3A%20Human%2C%20societal,human%20rights%2C%20diversity%2C%20and%20the%20autonomy%20of%20individuals.)_
- _[DTA policy for the responsible use of AI in government](https://www.digital.gov.au/ai/ai-in-government-policy)_
- relevant legislation and regulations
- relevant frameworks, and
- relevant learnings and outcomes from trials or implementations of AI within the commonwealth or other relevant organisations.

DPS’ approach to the adoption of AI is designed to:

- align with the [_Parliament of Australia Digital Strategy 2023-2027_](https://www.aph.gov.au/About_Parliament/Parliamentary_departments/Department_of_Parliamentary_Services/Publications/Digital_strategies)
...
DPS has adopted the Organisation for Economic Cooperation and Development’s (OECD) [definition](https://www.oecd.org/en/publications/explanatory-memorandum-on-the-updated-oecd-definition-of-an-ai-system_623da898-en.html) of what constitutes artificial intelligence.
...
| Domains                        |                                           |                  |                        |                                |
| ------------------------------ | ----------------------------------------- | ---------------- | ---------------------- | ------------------------------ |
| Analytics for insights         | Decision making and administrative action | Image processing | Workplace productivity |                                |
| Compliance and fraud detection | Internal use                              |                  | Internal use           |                                |
| Corporate and enabling         | Internal use                              |                  |                        | Internal use                   |
| Scientific                     |                                           |                  |                        |                                |
| Service delivery               | Internal use                              |                  |                        | Public facing and internal use |
| Policy and legal               |                                           |                  |                        | Internal use                   |

Table 1 - DPS AI use classification.

Under the [_Strategic Framework for the Parliamentary Service_](https://www.aph.gov.au/About_Parliament/Publications/Strategic_Framework_-_The_Parliamentary_Service?CalendarWidgetTarget=15-06-2025) (Strategic Framework), the parliamentary departments are committed to enhance engagement in the work of the Parliament.
...
DPS employs the DTA [AI impact assessment tool](https://www.digital.gov.au/ai/impact-assessment-tool/introduction) to support the safe and ethical use of AI. DPS monitors, logs and reports on the use of:
...
The DPS CIO was appointed as the DPS accountable official under the responsible use of AI in government policy on 30 September 2024, following the _[DTA standard for accountable officials](https://www.digital.gov.au/sites/default/files/documents/2025-12/Standard%20for%20accountability%202.0.pdf)_. The DPS CIO is accountable for:

- implementation of the DTA policy for the responsible use of AI in the Parliament
- reporting new high-risk use cases identified by DPS to the DTA via email to [ai@dta.gov.au](mailto:ai@dta.gov.au)
...
To enquire about AI and its use within the Parliament, please contact [DPS ICT service desk](mailto:dps-2020@aph.gov.au).